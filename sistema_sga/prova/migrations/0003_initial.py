...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'prova_prova', (
            ...
            ('descricao', self.gf('django.db.models.fields.CharField')(max_length=3000, null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('sobre', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prova.ProvaSobre'])),
            ('duracao', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'prova', ['Prova'])

        # Adding M2M table for field questoes on 'Prova'
        m2m_table_name = db.shorten_name(u'prova_prova_questoes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prova', models.ForeignKey(orm[u'prova.prova'], null=False)),
            ('questao', models.ForeignKey(orm[u'prova.questao'], null=False))
        ))
        db.create_unique(m2m_table_name, ['prova_id', 'questao_id'])

        # Adding model 'ProvaSobre'
        db.create_table(u'prova_provasobre', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assunto', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'prova', ['ProvaSobre'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field questoes on 'Prova'
        db.delete_table(db.shorten_name(u'prova_prova_questoes'))

        # Deleting model 'ProvaSobre'
        db.delete_table(u'prova_provasobre')
    ...
    models = {
        ...
        u'prova.prova': {
            ...
            'descricao': ('django.db.models.fields.CharField', [], {'max_length': '3000', 'null': 'True', 'blank': 'True'}),
            'duracao': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'questoes': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['prova.Questao']", 'symmetrical': 'False'}),
            'sobre': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['prova.ProvaSobre']"}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'})
        },
        u'prova.provasobre': {
            'Meta': {'object_name': 'ProvaSobre'},
            'assunto': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'prova.questao': {
