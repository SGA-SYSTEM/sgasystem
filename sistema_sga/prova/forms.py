...
class QuestaoForm(forms.ModelForm):
    questoes = forms.ChoiceField(choices=(), widget=forms.Select(
        attrs={'multiple': 'multiple', 'class': 'form-control'}),
        help_text='Mantenha o "Control", ou "Command" no Mac, pressionado para selecionar mais de uma opcao.')
