...
from sistema_sga.prova.models import Prova, Questao, Resposta, \
    QuestaoSobre, ProvaSobre, QuestaoDificuldade, UsuarioProva
...
class QuestaoAdmin(admin.ModelAdmin):
    list_display = [
        'questao', 'sobre', 'tipo', 'dificuldade', 'ativo', 'image']
...
class UsuarioProvaAdmin(admin.ModelAdmin):
    ...
    list_display = ['id', 'user', 'prova', 'data_expiracao', 'get_status',
                    'has_finished', 'has_expired', 'tempo_inicial',
                    'tempo_final']
    date_hierarchy = 'data_expiracao'
    search_fields = [
        'user__username', 'user__first_name', 'user__last_name', 'prova__name']
